    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, '展示'), (1, '隐藏')], null=True, verbose_name='是否发表')),
            ],
            options={
                'verbose_name': '分类',
        ...
        migrations.AddField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='tag_post', to='blog.Tag', verbose_name='标签'),
        ),
    ]
